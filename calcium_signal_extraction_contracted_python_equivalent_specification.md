...
- **Sliding F0**: Per‑ROI adaptive sliding window (~50 s, capped at 40% of recording), fixed percentile at the 10th (low=high=10) for all frames; yields F0(t) and dF/F = (F−F0)/F0.
